...
import time
import logging
from AnantaAI.backend.qna import ContextAgent, QAAgent, SentenceTransformer, QAConfig, JSONContentSource
...
def test_basic_functionality():
    ...
    try:
        ...
        for i, query in enumerate(test_queries, 1):
            ...
            print(
                f"   📚 Sources: {len(result.get('metadata', {}).get('sources_used', []))}")
